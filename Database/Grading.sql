...
INSERT INTO `Credential` (`email`, `password`) VALUES ('c@bu.edu', '');
INSERT INTO `Professor` (`first_name`, `last_name`, `email`, `credentialId`) VALUES ('Christine', 'Papadakis', 'c@bu.edu', '1');

INSERT INTO `CourseSection` (`name`) VALUES ('Default Section');
INSERT INTO `CourseSection` (`name`) VALUES ('Morning Section');
